                                                                    ...
                                                                    <p className="mt-6 text-lg leading-8 text-gray-300 text-center max-w-2xl mb-12">
                                                                                  Manage your links, share your portfolio, and connect with the world.
                                                                                                  ...
                                                                                                  <div className="mt-10 flex items-center justify-center gap-x-6">
                                                                                                                <a
                                                                                                                            href="/login"
                                                                                                                                        className="rounded-md bg-blue-600 px-6 py-3 text-lg font-semibold text-white shadow-sm hover:bg-blue-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-600 transition"
                                                                                                                                                  >
                                                                                                                                                                  Get started
                                                                                                                                                                            </a>
                                                                                                                                                                                    </div>
