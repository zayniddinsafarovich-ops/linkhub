                                                          ...
                                                          <p className="mt-6 text-lg leading-8 text-gray-300 text-center max-w-2xl">
                                                                    Manage your links, share your portfolio, and connect with the world.
                                                                                ...
                                                                                <div className="mt-10 flex items-center justify-center gap-x-6">
                                                                                            <a href="/login" className="rounded-md bg-blue-500 px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-blue-400 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-400">
                                                                                                      Get started
                                                                                                              </a>
                                                                                                                    </div>
                                                                                                                        </main>
